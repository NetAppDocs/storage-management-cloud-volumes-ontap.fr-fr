...
+
image:https://raw.githubusercontent.com/NetAppDocs/bluexp-family/main/media/screenshot-case-management-actions.png["Une capture d'écran qui montre les actions que vous pouvez entreprendre après avoir sélectionné le menu dans la dernière colonne du tableau."]
