...
+
link:https://docs.netapp.com/us-en/data-services-backup-recovery/concept-backup-to-cloud.html["En savoir plus sur la sauvegarde et la récupération"^]
...
+
https://docs.netapp.com/us-en/data-services-data-classification/concept-cloud-compliance.html["En savoir plus sur la classification des données"^]
...
link:https://www.netapp.com/ontap-cloud/["En savoir plus sur Cloud Volumes ONTAP"^]
