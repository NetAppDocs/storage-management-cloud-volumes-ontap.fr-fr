...
NOTE: NetApp a restreint l'achat, la prolongation et le renouvellement des licences BYOL, et a limité la disponibilité dans des scénarios spécifiques, tels que les déploiements en mode privé. Pour plus d'informations, consultez  https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap["Disponibilité restreinte des licences BYOL pour Cloud Volumes ONTAP"^].
...
Pour plus de détails sur les prix, rendez-vous sur link:https://www.netapp.com/pricing/["site web de tarification NetApp"^].
...
* link:task-convert-node-capacity.html["Convertir une licence basée sur les nœuds en une licence basée sur la capacité"]
* link:task-manage-keystone.html["Gérer les abonnements Keystone"]
