...
. En haut à droite de la console, cliquez sur l’image:icon-action.png["Une icône représentant trois points horizontaux pour des actions supplémentaires"]icône et sélectionnez *Supprimer de l’espace de travail*.
