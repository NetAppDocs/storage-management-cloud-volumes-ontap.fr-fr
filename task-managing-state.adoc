...
summary: Vous pouvez arrêter et démarrer Cloud Volumes ONTAP à partir de la console NetApp pour gérer vos coûts de calcul cloud. 
---
...
[role="lead"]
Vous pouvez arrêter et démarrer Cloud Volumes ONTAP à partir de la console NetApp pour gérer vos coûts de calcul cloud.
