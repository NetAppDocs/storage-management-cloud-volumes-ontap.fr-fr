...
.Étapes
. Supprimez le système Cloud Volumes ONTAP. Consultez link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-removing.html["Suppression des systèmes Cloud Volumes ONTAP"].
