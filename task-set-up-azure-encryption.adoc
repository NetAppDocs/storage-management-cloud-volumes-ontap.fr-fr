...
----
https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["Afficher la dernière liste des autorisations"^]

.Étapes
. Obtenez la liste des coffres-forts de clés dans votre abonnement Azure en utilisant les appels d'API suivants.
+
https://docs.netapp.com/us-en/console-automation/cvo/get-azure-ha-metadata-keys-vault.html["Pour une paire haute disponibilité"^]: `GET /azure/ha/metadata/vaults`

+
https://docs.netapp.com/us-en/console-automation/cvo/get-azure-vsa-metadata-keys-vault.html["Pour un seul nœud"^]: `GET /azure/vsa/metadata/vaults`
...
+
Pour une paire haute disponibilité `GET /azure/ha/metadata/keys-vault?resourceGroupName=KeyVaultResourceGroup&vaultName=KeyVault`

+
Pour un seul nœud : `GET /azure/vsa/metadata/keys-vault?resourceGroupName=KeyVaultResourceGroup&vaultName=KeyVault`
...
+
.. Pour une paire haute disponibilité, utilisez https://docs.netapp.com/us-en/console-automation/cvo/post-azure-ha-working-environments.html["cet appel API"^] :
+
...
.. Pour un système à nœud unique, utilisez https://docs.netapp.com/us-en/console-automation/cvo/post-azure-vsa-working-environments.html["cet appel API"^] :
+
...
.Liens connexes
* https://docs.netapp.com/us-en/console-automation/cm/wf_cvo_before.html["Préparez-vous à utiliser les workflows de l'API Cloud Volumes ONTAP"^].
* https://docs.netapp.com/us-en/console-automation/cm/api_ref_resources.html#azure-haworking-environments["Découvrez les API REST de gestion ONTAP"^].
