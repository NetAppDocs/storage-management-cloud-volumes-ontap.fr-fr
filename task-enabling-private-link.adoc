...
https://docs.netapp.com/us-en/console-setup-admin/task-configuring-proxy.html#enable-a-proxy-on-a-connector["Découvrez comment activer le trafic API direct sur l'agent de la console"^]
