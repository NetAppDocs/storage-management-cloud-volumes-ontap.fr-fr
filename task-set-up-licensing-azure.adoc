...
Choisissez l'offre Freemium pour utiliser Cloud Volumes ONTAP gratuitement avec jusqu'à 500 Gio de capacité provisionnée. link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#packages["En savoir plus sur l'offre Freemium"^].
...
+
Vous ne serez pas facturé via l'abonnement au marketplace sauf si vous dépassez 500 Gio de capacité provisionnée, auquel cas le système est automatiquement converti en link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#capacity-based-licensing["Forfait Essentiel"^].
...
+
Votre licence doit être disponible depuis la Console avant de pouvoir l'utiliser avec Cloud Volumes ONTAP. Si nécessaire, vous pouvez link:task-manage-capacity-licenses.html#how-licenses-are-added-to-netapp-console["ajouter manuellement la licence à la console"].
...
TIP: Vous pouvez gérer les abonnements Azure Marketplace associés à vos comptes Azure depuis la page Paramètres > Informations d'identification. https://docs.netapp.com/us-en/console-setup-admin/task-adding-azure-accounts.html["Apprenez à gérer vos comptes et abonnements Azure"^]
