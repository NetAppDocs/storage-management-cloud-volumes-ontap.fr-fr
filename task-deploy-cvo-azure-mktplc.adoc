...
* Une licence gratuite pour Cloud Volumes ONTAP est fournie pour une capacité provisionnée maximale de 500 Gio, sans support NetApp et sans date d'expiration. La capacité au-delà de 500 Gio nécessite un droit de licence valide et peut entraîner des frais. Pour accéder à l'expérience complète Cloud Volumes ONTAP et aux fonctionnalités avancées de gestion, connectez votre système Cloud Volumes ONTAP à la Console. La découverte et la gestion via la Console nécessitent un abonnement valide à Azure Marketplace associé à votre compte Console.
...
.Avant de commencer
* Si vous prévoyez de découvrir et de gérer le système déployé dans la Console, assurez-vous que le compte Console est associé à un abonnement valide Azure Marketplace. La découverte du système dans la Console nécessite un abonnement valide.
