...
--
Taille du disque GCP:: Vous devez choisir une taille de disque initiale lorsque vous déployez un système Cloud Volumes ONTAP .  Après cela, vous pouvez laisser la console NetApp gérer la capacité d'un système pour vous, mais si vous souhaitez créer vous-même des agrégats, tenez compte des points suivants :
+
--
