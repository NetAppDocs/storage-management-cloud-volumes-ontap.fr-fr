...
Type de machine:: Consultez les types de machines pris en charge dans le https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/reference-configs-gcp.html["Notes de version de Cloud Volumes ONTAP"^] Consultez ensuite les informations détaillées de Google concernant chaque type de machine pris en charge. Adaptez vos exigences de charge de travail au nombre de vCPU et de mémoire pour le type de machine. Notez que chaque cœur de processeur augmente les performances du réseau.
+
--
