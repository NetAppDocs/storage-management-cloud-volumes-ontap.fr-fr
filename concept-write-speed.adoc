...
---
= Découvrez la vitesse d'écriture sur Cloud Volumes ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
link:reference-configs-aws.html["En savoir plus sur les instances Amazon EC2 prises en charge par Cloud Volumes ONTAP"].
...
Si vous utilisez un système à nœud unique, Cloud Volumes ONTAP prend en charge une vitesse d'écriture élevée avec tous les types de VM.

Si vous utilisez une paire haute disponibilité, Cloud Volumes ONTAP prend en charge une vitesse d'écriture élevée avec plusieurs types de machines virtuelles, à partir de la version 9.8. Accédez à la link:reference-configs-azure.html["Notes de version de Cloud Volumes ONTAP"] pour consulter les types de machines virtuelles qui prennent en charge une vitesse d'écriture élevée.
...
Si vous utilisez une paire haute disponibilité, Cloud Volumes ONTAP prend en charge une vitesse d'écriture élevée avec plusieurs types de machines virtuelles, à partir de la version 9.13.0. Accédez à la link:reference-configs-gcp.html#supported-configurations-by-license["Notes de version de Cloud Volumes ONTAP"^] pour consulter les types de machines virtuelles qui prennent en charge une vitesse d'écriture élevée.

link:reference-configs-gcp.html["En savoir plus sur les types de machines Google Cloud pris en charge par Cloud Volumes ONTAP"^].
