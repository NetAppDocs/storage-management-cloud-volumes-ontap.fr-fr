...
.Référence
Pour obtenir la liste des types d'instances pris en charge dans AWS, consultez link:reference-configs-aws.html#supported-ec2-compute["Instances EC2 prises en charge"].
