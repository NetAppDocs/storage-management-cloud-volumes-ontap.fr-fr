...
** Le compte de service associé à l'agent de la console https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-gcp.html["devrait avoir les autorisations requises"^]
...
| Modifier le projet  a| 
Sélectionnez le projet dans lequel vous souhaitez que Cloud Volumes ONTAP réside.
...
. *Modèles de déploiement HA* : Choisissez plusieurs zones (recommandé) ou une seule zone pour la configuration HA. Sélectionnez ensuite une région et une zone.
+
