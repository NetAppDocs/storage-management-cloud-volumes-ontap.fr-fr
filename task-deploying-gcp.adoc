...
+
Apprenez-en davantage sur  https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/reference-configs-gcp.html#flash-cache-support["Cache Flash"^] et link:concept-write-speed.html["vitesse d'écriture"].
