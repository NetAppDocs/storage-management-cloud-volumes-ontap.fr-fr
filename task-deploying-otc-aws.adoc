...
---
= Déployez Cloud Volumes ONTAP en utilisant les options avancées dans AWS
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
+
** Vous devriez avoir un https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-connector-aws.html["Agent de console associé à votre système"^].
...
. Si vous y êtes invité, https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-connector-aws.html["créer un agent de console"^].
...
| Modifier les informations d'identification | Choisissez les identifiants AWS associés au compte sur lequel vous souhaitez déployer ce système. Vous pouvez également associer l'abonnement AWS Marketplace à utiliser avec ce système Cloud Volumes ONTAP. Cliquez sur *Add Subscription* pour associer les identifiants sélectionnés à un nouvel abonnement AWS Marketplace. L'abonnement peut porter sur un contrat annuel ou sur un paiement de Cloud Volumes ONTAP à un tarif horaire. https://docs.netapp.com/us-en/console-setup-admin/task-adding-aws-accounts.html["Découvrez comment ajouter des informations d'identification AWS supplémentaires à la NetApp Console"^]. 
|===
+
...
. *Emplacement et connectivité* : Saisissez les informations réseau que vous avez enregistrées dans le https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config.html#collect-networking-information["Feuille de travail AWS"^].
+
...
| Modifier les informations d'identification | Choisissez les identifiants AWS et l’abonnement à la marketplace à utiliser avec ce système Cloud Volumes ONTAP. Cliquez sur *Ajouter un abonnement* pour associer les identifiants sélectionnés à un nouvel abonnement AWS Marketplace. L’abonnement peut être un contrat annuel ou permettre de payer Cloud Volumes ONTAP à un tarif horaire. Si vous avez acheté une licence directement auprès de NetApp (Bring-Your-Own License ou BYOL), alors un abonnement AWS n’est pas requis. NetApp a restreint l’achat, l’extension et le renouvellement des licences BYOL. Pour plus d’informations, consultez  https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap["Disponibilité restreinte des licences BYOL pour Cloud Volumes ONTAP"^]. https://docs.netapp.com/us-en/console-setup-admin/task-adding-aws-accounts.html["Découvrez comment ajouter des informations d'identification AWS supplémentaires à la console"^]. 
|===
+
...
+
** https://docs.netapp.com/us-en/data-services-data-classification/concept-cloud-compliance.html["En savoir plus sur la NetApp Data Classification"^]
** https://docs.netapp.com/us-en/data-services-backup-recovery/task-backup-to-s3.html["En savoir plus sur la sauvegarde et la récupération"^]
+
...
. *Profil d'utilisation, type de disque et politique de hiérarchisation* : choisissez si vous souhaitez activer les fonctionnalités d'efficacité du stockage et modifier la politique de hiérarchisation des volumes, si nécessaire.
+
Pour plus d'informations, consultez link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config.html#choose-a-volume-usage-profile["Choisissez un profil d'utilisation du volume"^] et link:concept-data-tiering.html["Présentation de la hiérarchisation des données"^].
...
.Liens connexes
* link:task-onboard-cvo-aws-marketplace.html["Abonnez-vous et déployez Cloud Volumes ONTAP depuis AWS Marketplace"]
