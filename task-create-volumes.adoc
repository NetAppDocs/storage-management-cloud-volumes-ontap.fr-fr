...
* Lorsque vous créez un volume iSCSI, la Console crée automatiquement un LUN pour vous. Nous avons simplifié le processus en ne créant qu'un seul LUN par volume, de sorte qu'aucune gestion n'est nécessaire. Après avoir créé le volume, link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-connect-lun.html["utilisez l'IQN pour vous connecter au LUN depuis vos hôtes"^].
* Vous pouvez créer des LUN supplémentaires à partir d' ONTAP System Manager ou de l' ONTAP CLI.


ifdef::aws[]

* Pour utiliser CIFS dans AWS, vous devez avoir configuré DNS et Active Directory. Pour plus d'informations, consultez link:reference-networking-aws.html["Exigences réseau pour Cloud Volumes ONTAP dans AWS"].
...
.Agrégat spécifique
--
.. Dans l'onglet *Agrégats*, accédez à l'agrégat souhaité et cliquez sur l'icône image:icon-action.png["Une icône représentant trois points horizontaux pour des actions supplémentaires"].
...
+
*** link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config.html#size-your-system-in-aws["Dimensionnement de votre système dans AWS"^]
...
* link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config-azure.html#size-your-system-in-azure["Dimensionnement de votre système dans Azure"^]
...
* link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config-gcp.html#size-your-system-in-gcp["Dimensionnement de votre système dans Google Cloud"^]
