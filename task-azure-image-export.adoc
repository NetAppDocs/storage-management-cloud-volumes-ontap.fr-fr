...
----
+
L'URL suit un format standard. Pour l'automatisation, vous pouvez générer la chaîne URL comme indiqué ci-dessous. Vous pouvez également utiliser la commande  `az` Azure CLI pour obtenir l'URL. Exemple d'URL : +https://examplesaname.bluexpinfraprod.eastus2.data.azurecr.io/vm-images/9150.01000024.05090105.vhd+
