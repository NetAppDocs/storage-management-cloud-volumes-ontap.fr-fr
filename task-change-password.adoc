...
. En haut à droite de la console, cliquez sur l’icône image:icon-action.png["Une icône représentant trois points horizontaux pour des actions supplémentaires"] et sélectionnez *Définir le mot de passe*.
+
