...
+
Consultez  https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-azure-download-digest-file.html["Téléchargez le fichier de résumé de l'image Azure"^] pour plus d'informations.
