...
[role="lead"]
https://www.netapp.com/data-services/digital-advisor/["NetApp Active IQ Digital Advisor"^](également connu sous le nom de Digital Advisor) est intégré à la NetApp Console afin que vous puissiez optimiser les opérations, la sécurité et les performances de vos systèmes Cloud Volumes ONTAP sur une seule interface.
