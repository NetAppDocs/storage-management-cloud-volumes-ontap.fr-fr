...
.Étapes
. Si vous avez activé la sauvegarde et la restauration sur le système, déterminez si les données sauvegardées sont toujours nécessaires, puis… https://docs.netapp.com/us-en/data-services-backup-recovery/prev-ontap-backup-manage.html#delete-backups["supprimer les sauvegardes, si nécessaire"^] .
+
...
+
https://docs.netapp.com/us-en/data-services-data-classification/concept-cloud-compliance.html#the-cloud-data-sense-instance["En savoir plus sur l'instance de classification des données"^].
...
.. En haut à droite de la console, cliquez sur l’icône image:icon-action.png["Une icône représentant trois points horizontaux pour des actions supplémentaires"] et sélectionnez *Supprimer*.
