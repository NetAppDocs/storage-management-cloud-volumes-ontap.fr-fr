...
| Gamme complète de types de machines virtuelles. link:reference-configs-azure.html["Configurations prises en charge dans Azure"] 
...
| *Type de disque pris en charge* | Disques gérés SSD Premium v2 | Un soutien plus large. link:reference-configs-azure.html#azure-storage-for-user-data["Types de disques pris en charge dans Azure"] 
...
* link:https://docs.netapp.com/us-en/console-family/index.html["Documentation de la NetApp Console"^]
