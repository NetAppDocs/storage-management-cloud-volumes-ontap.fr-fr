...
+
Cette option est disponible uniquement pour certains types de machines virtuelles. Pour connaître les types de machines virtuelles compatibles, veuillez consulter link:link:reference-configs-azure.html#ha-pairs["Configurations prises en charge par licence pour les paires HA"].
...
+
link:link:reference-configs-azure.html#ha-pairs["En savoir plus sur les configurations prises en charge dans Azure"^].
