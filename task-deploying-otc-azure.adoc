...
---
= Déployez Cloud Volumes ONTAP à l'aide des options avancées dans Azure
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
+
** Vous devriez avoir un https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-connector-azure.html["Agent de console associé à votre système"^].
...
. Si vous y êtes invité, https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-connector-azure.html["créer un agent de console"^].
...
| Modifier les informations d'identification | Vous pouvez choisir des informations d'identification Azure et un abonnement Azure différents à utiliser avec ce système Cloud Volumes ONTAP. Vous devez associer un abonnement Azure Marketplace à l'abonnement Azure sélectionné afin de déployer un système Cloud Volumes ONTAP à paiement à l'usage. https://docs.netapp.com/us-en/console-setup-admin/task-adding-azure-accounts.html["Apprenez à ajouter des informations d'identification"^] 
|===
...
+
** https://docs.netapp.com/us-en/data-services-data-classification/concept-cloud-compliance.html["En savoir plus sur la NetApp Data Classification"^]
...
TIP: Si le compte Azure que vous utilisez possède l https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["autorisations requises"^]attribut, la NetApp Console supprime les ressources Cloud Volumes ONTAP d'un groupe de ressources en cas d'échec de déploiement ou de suppression.
...
| Utiliser l'existant | Si vous choisissez un groupe de sécurité existant, celui-ci doit répondre aux exigences de Cloud Volumes ONTAP. link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/reference-networking-azure.html#security-group-rules["Afficher le groupe de sécurité par défaut"^]. 
|===
...
NOTE: Si une version candidate, une version disponible pour tous ou un correctif plus récent est disponible pour la version sélectionnée, alors la Console met à jour le système vers cette version lors de la création de l’environnement de travail. Par exemple, la mise à jour a lieu si vous sélectionnez Cloud Volumes ONTAP 9.16.1 P3 et que 9.16.1 P4 est disponible. La mise à jour n’a pas lieu d’une version à une autre—for example, de 9.15 à 9.16.
...
+
Pour obtenir de l'aide concernant le choix du type et de la taille du disque, reportez-vous à link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config-azure.html#size-your-system-in-azure["Dimensionnement de votre système dans Azure"^].
...
+
Cette option est disponible uniquement pour certains types de machines virtuelles. Pour connaître les types de machines virtuelles compatibles, veuillez consulter link:reference-configs-azure.html#ha-pairs["Configurations prises en charge par licence pour les paires HA"].
...
+
Pour plus d'informations, consultez link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config-azure.html#choose-a-volume-usage-profile["Comprendre les profils d'utilisation du volume"^] et link:concept-data-tiering.html["Présentation de la hiérarchisation des données"^].
...
** La taille du disque concerne tous les disques de l’agrégat initial et tous les agrégats supplémentaires créés par la console lorsque vous utilisez l’option de provisionnement simple.  Vous pouvez créer des agrégats qui utilisent une taille de disque différente en utilisant l'option d'allocation avancée.
+
Pour obtenir de l'aide concernant le choix de la taille du disque, reportez-vous à link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config-azure.html#size-your-system-in-azure["Dimensionnez votre système dans Azure"^].
...
+
link:reference-configs-azure.html#ha-pairs["En savoir plus sur les configurations prises en charge dans Azure"^].
...
.Liens connexes
* link:task-planning-your-config-azure.html["Planification de votre configuration Cloud Volumes ONTAP dans Azure"^]
* link:task-deploy-cvo-azure-mktplc.html["Déployer Cloud Volumes ONTAP dans Azure depuis la Place de marché Azure"^]
