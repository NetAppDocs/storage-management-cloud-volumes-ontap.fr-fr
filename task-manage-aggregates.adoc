...
. Pour l’agrégat requis, cliquez sur l’icône image:icon-action.png["Une icône représentant trois points horizontaux pour des actions supplémentaires"] pour les actions de gestion.
+
image:screenshot_aggr_menu_options.png["Une capture d’écran des options du menu Agrégats."]

. Gérez vos agrégats à partir des options disponibles dans le menu image:icon-action.png["Une icône représentant trois points horizontaux pour des actions supplémentaires"].
...
. Dans le menu image:icon-action.png["Une icône représentant trois points horizontaux pour des actions supplémentaires"], cliquez sur *Augmenter la capacité*.
