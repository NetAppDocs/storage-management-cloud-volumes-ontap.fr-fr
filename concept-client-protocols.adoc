...
À partir de la version ONTAP 9.12.1, NVMe-TCP est pris en charge pour tous les fournisseurs de cloud.  Cloud Volumes ONTAP prend en charge NVMe-TCP comme protocole de bloc pour les machines virtuelles de stockage (SVM) lors du déploiement et installe automatiquement les licences NVMe requises.

La NetApp Console ne fournit aucune fonctionnalité de gestion pour NVMe-TCP.
