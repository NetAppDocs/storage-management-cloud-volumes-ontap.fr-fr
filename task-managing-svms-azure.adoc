...
Pour obtenir des informations sur l’exécution des appels d’API Cloud Volumes ONTAP, reportez-vous à https://docs.netapp.com/us-en/console-automation/cm/your_api_call.html#step-1-select-the-identifie["Votre premier appel d'API"^].
...
En fonction de votre configuration et de votre type de licence, vous pouvez créer plusieurs machines virtuelles de stockage sur un système à nœud unique ou dans une configuration à haute disponibilité (HA) en utilisant les API pour la NetApp Console.
...
.Avant de commencer
L'agent Console requiert des autorisations spécifiques pour créer des machines virtuelles de stockage pour Cloud Volumes ONTAP. Les autorisations requises sont incluses dans https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["les politiques fournies par NetApp"^].
...
Utilisez l'appel API suivant pour créer une machine virtuelle de stockage sur un système à nœud unique.
...
== Gérer les machines virtuelles de stockage sur des systèmes à nœud unique et des paires haute disponibilité
...
.Avant de commencer
L'agent Console requiert des autorisations spécifiques pour gérer les machines virtuelles de stockage pour Cloud Volumes ONTAP. Les autorisations requises sont incluses dans https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["les politiques fournies par NetApp"^].
...
.Étapes
* Utilisez l'appel API suivant pour renommer une machine virtuelle de stockage sur un système à nœud unique :
+
...
.Étapes
* Utilisez l'appel API suivant pour supprimer une machine virtuelle de stockage sur un système à nœud unique :
+
...
* https://docs.netapp.com/us-en/console-automation/platform/use_rest_apis.html["Utiliser les API REST pour la NetApp Console"^]
