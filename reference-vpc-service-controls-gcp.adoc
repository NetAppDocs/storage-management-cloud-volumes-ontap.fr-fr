...
Les politiques permettent de déroger aux règles de contrôle des services VPC. Pour plus d'informations sur les politiques, veuillez consulter la  https://cloud.google.com/vpc-service-controls/docs/ingress-egress-rules#policy-model["Documentation relative à la politique de contrôle des services VPC de Google Cloud"^].
