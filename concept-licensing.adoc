...
* link:link:reference-configs-azure.html["Configurations prises en charge dans Azure"]
...
* link:link:reference-configs-gcp.html["Configurations prises en charge dans Google Cloud"^]
