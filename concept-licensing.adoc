...
[role="lead"]
Plusieurs modèles de licence sont disponibles pour Cloud Volumes ONTAP. Chaque option vous permet de choisir un modèle de consommation adapté à vos besoins.

Vous avez la possibilité d’acheter ou de renouveler vos licences et abonnements sur les marketplaces cloud ou via NetApp (Bring-Your-Own License ou BYOL). La marketplace vous propose des abonnements annuels et des options de paiement à l’utilisation (PAYGO). Pour plus d’informations, consultez link:concept-license-management.html["En savoir plus sur les licences basées sur la capacité pour Cloud Volumes ONTAP"].

Les licences BYOL sont disponibles à l'achat auprès de NetApp et peuvent être utilisées avec n'importe quel fournisseur de cloud. Pour plus d'informations sur la disponibilité des licences BYOL, consultez  https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap["Disponibilité restreinte des licences BYOL pour Cloud Volumes ONTAP"^].
...
Les nouveaux clients peuvent opter pour une facturation via des abonnements annuels au marketplace basés sur la capacité ou des abonnements Keystone. Quelques déploiements, comme ceux en mode privé, disposent également des licences BYOL de génération précédente, basées sur les nœuds.

Licences basées sur la capacité:: Payez plusieurs systèmes Cloud Volumes ONTAP dans votre compte NetApp par capacité provisionnée. Inclut la possibilité d’acheter des services de données cloud complémentaires. Pour plus d'informations sur les modèles de consommation ou les options d'achat de licences basées sur la capacité, veuillez consulter :link:concept-licensing-charging.html["En savoir plus sur les licences basées sur la capacité"] .
...
* link:reference-configs-azure.html["Configurations prises en charge dans Azure"]
...
* link:reference-configs-gcp.html["Configurations prises en charge dans Google Cloud"^]
...
NOTE: Un abonnement à la carte (PAYGO) est requis pour la sauvegarde et la restauration, cependant aucun frais ne sera facturé pour l'utilisation de ce service. Pour plus d'informations sur la configuration des licences pour la sauvegarde et la restauration, consultez  https://docs.netapp.com/us-en/data-services-backup-recovery/task-licensing-cloud-backup.html["Configurer les licences pour la sauvegarde et la récupération"^].
...
https://docs.netapp.com/us-en/console-setup-admin/concept-connectors.html#impact-on-cloud-volumes-ontap["En savoir plus sur les agents de console"^].


NOTE: NetApp a restreint l'achat, la prolongation et le renouvellement des licences BYOL. Pour plus d'informations, consultez  https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap["Disponibilité restreinte des licences BYOL pour Cloud Volumes ONTAPP"^].
...
Les abonnements Keystone sont compatibles avec les paires haute disponibilité. Cette option de licence n'est pas prise en charge pour les systèmes à nœud unique actuellement.
...
NOTE: Déploiements de Cloud Volumes ONTAP en mode privé dans un environnement privé.
...
| Type de licence | Impact après l'EOA 
 ...
 a| 
Licence valide basée sur les nœuds achetée auprès de NetApp ou BYOL.
 a| 
La licence reste valable jusqu'à son expiration.  Les licences basées sur des nœuds inutilisées existantes peuvent être utilisées pour déployer de nouveaux systèmes Cloud Volumes ONTAP .
 ...
 a| 
Licence BYOL basée sur un nœud expirée.
 a| 
...
|===
.Exceptions
NetApp reconnaît que certaines situations nécessitent une attention particulière, telles que les déploiements de Cloud Volumes ONTAP dans la région Chine sur AWS, et que les clauses EOA et EOS des licences basées sur les nœuds peuvent ne pas s'appliquer aux cas suivants :
...
La console permet une conversion transparente des licences par nœud en licences par capacité grâce à l’outil de conversion de licences. Pour plus d’informations sur l’EOA des licences par nœud, veuillez consulter link:concept-licensing.html#end-of-availability-of-node-based-licenses["Fin de disponibilité des licences basées sur des nœuds"].
...
##Si vous avez des abonnements à la marketplace ou des déploiements privés avec des licences par nœud, vous pouvez link:task-convert-node-capacity.html["Convertissez vos licences par nœud en licences par capacité"] utiliser l’outil de conversion de licences dans la NetApp Console.##
...
.Liens connexes
* link:concept-licensing-charging.html["En savoir plus sur les licences basées sur la capacité"]
