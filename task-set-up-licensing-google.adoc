...
. https://docs.netapp.com/us-en/console-setup-admin/task-adding-nss-accounts.html#add-an-nss-account["Ajoutez votre compte de site de support NetApp à la NetApp Console"^]
+
...
TIP: Vous pouvez gérer les abonnements Google Cloud Marketplace associés à vos comptes depuis la page Paramètres > Identifiants. https://docs.netapp.com/us-en/console-setup-admin/task-adding-gcp-accounts.html["Découvrez comment gérer vos identifiants et abonnements Google Cloud"^]
