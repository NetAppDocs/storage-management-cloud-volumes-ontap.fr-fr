...
.Étapes
Un utilisateur Azure disposant des privilèges _Owner_ peut activer la fonctionnalité à partir de l’Azure CLI.
...
.Liens connexes
. https://learn.microsoft.com/en-us/azure/load-balancer/load-balancer-ha-ports-overview["Documentation Microsoft Azure : vue d’ensemble des ports à haute disponibilité"^]
. https://learn.microsoft.com/en-us/cli/azure/get-started-with-azure-cli?view=azure-cli-latest["Microsoft Azure documentation : Premiers pas avec Azure CLI"^]
