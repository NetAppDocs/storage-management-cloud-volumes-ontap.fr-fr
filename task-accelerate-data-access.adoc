...
NetApp Console permet la gestion des volumes FlexCache avec le link:https://docs.netapp.com/us-en/console-volume-caching/index.html["NetApp Mise en cache du volume"^].
