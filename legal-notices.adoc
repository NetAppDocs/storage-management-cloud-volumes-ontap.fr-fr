...
* https://docs.netapp.com/us-en/bluexp-setup-admin/media/notice.pdf["Avis concernant la NetApp Console"^]
* https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/legal-notices.html#open-source["Avis concernant Cloud Volumes ONTAP"^]
* https://docs.netapp.com/us-en/ontap/reference_legal_notices.html#open-source["Avis pour ONTAP"^]
