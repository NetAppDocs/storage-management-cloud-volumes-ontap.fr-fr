...
Ces autorisations sont incluses dans https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-aws.html["les politiques fournies par NetApp"^]
...
+
https://docs.netapp.com/us-en/data-services-replication/task-replicating-data.html["Apprenez à configurer la réplication des données"^]
