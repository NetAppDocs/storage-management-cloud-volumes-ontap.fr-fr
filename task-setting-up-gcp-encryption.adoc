...
+
Les autorisations sont fournies dans le https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-gcp.html["les autorisations du compte de service par défaut"^] , mais peut ne pas s'appliquer si vous utilisez un autre projet pour le service de gestion des clés cloud.
...
Consultez la  https://docs.netapp.com/us-en/console-automation/index.html["Documentation sur l'automatisation de la NetApp Console"^] pour plus de détails sur l’utilisation du paramètre « GcpEncryption ».
