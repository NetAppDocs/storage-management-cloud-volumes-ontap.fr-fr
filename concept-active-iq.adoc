...
* Si vous n'avez pas encore enregistré de compte NSS dans la Console, enregistrez un compte NSS maintenant, puis l'interface utilisateur de Digital Advisor s'affichera. Consultez  https://docs.netapp.com/us-en/console-setup-admin/task-adding-nss-accounts.html["Gérer les informations d'identification NSS associées à une organisation ou à un compte"] pour obtenir les instructions.
