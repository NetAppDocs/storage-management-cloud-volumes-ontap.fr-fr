...
---
= Modifier la vitesse d'écriture du système dans Cloud Volumes ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
La vitesse d'écriture élevée est prise en charge par tous les types de systèmes à nœud unique et certaines configurations de paire haute disponibilité. Consultez les configurations prises en charge dans la https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/["Notes de version de Cloud Volumes ONTAP"^]
