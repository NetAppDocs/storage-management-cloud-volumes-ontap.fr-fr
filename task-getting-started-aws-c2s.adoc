...
+
Pour en savoir plus sur le fonctionnement du mode privé, consultez link:https://docs.netapp.com/us-en/console-setup-admin/concept-modes.html#private-mode["le mode de déploiement privé dans la console"^].
...
. Configurez un point de terminaison VPC vers le service Amazon Simple Storage Service (Amazon S3).
+
